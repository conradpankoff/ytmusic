...
alter table videos drop transcoded_360_at;
alter table videos drop transcoded_720_at;
-- alter table videos drop transcoded_800_at;
alter table videos add transcoded_360_at timestamp;
alter table videos add transcoded_720_at timestamp;
